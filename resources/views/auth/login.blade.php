                    ...
                    <div class="text-center mt-4">
                        <div class="mb-3">
                            <a href="index.html" class="auth-logo">
                                <img src="{{ asset('logo/logo.jpg') }}" height="50" class="logo-dark mx-auto"
                                    style="border-radius: 50%;" alt="company logo">
                                <img src="{{ asset('logo/logo.jpg') }}" height="50" class="logo-light mx-auto"
                                    style="border-radius: 50%;" alt="company logo">
                            </a>
                        </div>
                    </div>
