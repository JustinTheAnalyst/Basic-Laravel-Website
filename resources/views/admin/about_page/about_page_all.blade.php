                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('update.about') }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="short_description-input" class="col-sm-2 col-form-label">Short
                                    Description</label>
                                <div class="col-sm-10">
                                    <textarea name="short_description" id="short_description" required=""
                                        class="form-control"
                                        rows="5">{{ trim($aboutpage->short_description) }}</textarea>
                                </div>
                            </div>

                            <div class="row mb-3">
                                <label for="long_description-input" class="col-sm-2 col-form-label">Long
                                    Description</label>
                                <div class="col-sm-10">
                            ...
                            <div class="row mb-3">
                                <label for="about-image" class="col-sm-2 col-form-label">About Image</label>
                                <div class="col-sm-10">
